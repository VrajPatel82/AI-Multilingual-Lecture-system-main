    ...
    <div className="flex h-screen w-full bg-gradient-to-b from-[#f2f7ff] to-white">
        ...
        <div className="h-[80px] flex items-center px-6 border-b border-[#e6eaf2]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] leading-[18px] text-[#64748b]">Super Admin</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-auto border-t border-[#e6eaf2] p-4">
          <div className="flex items-center gap-3 p-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-[#0f172a] truncate">{user?.name || 'Super Admin'}</p>
              <p className="text-xs text-[#64748b] truncate">{user?.email || 'Platform Owner'}</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-[80px] bg-white border-b border-[#e6eaf2] flex items-center justify-between px-4 lg:px-8 shrink-0">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-1.5 bg-[#f0fdf4] px-3 py-1.5 rounded-full mr-2">
