  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Institutions', value: stats.totalInstitutions || stats.institutions || 0, icon: '🏛' },
          ...
          { label: 'Users', value: stats.totalUsers || stats.users || 0, icon: '👥' }
        ].map(s => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-surface rounded-card shadow-card border border-border">
          ...
          <div className="p-4 grid grid-cols-2 gap-3">
            {[
              { label: 'Institutions', link: '/super-admin/institutions', icon: '🏛' },
              { label: 'Inst Admins', link: '/super-admin/inst-admins', icon: '👤' },
              { label: 'Monitoring', link: '/super-admin/monitoring', icon: '📡' },
              { label: 'Security Logs', link: '/super-admin/security-logs', icon: '🔒' },
              { label: 'Analytics', link: '/super-admin/analytics', icon: '📊' },
              { label: 'Policies', link: '/super-admin/policies', icon: '📋' }
            ].map(a => (
